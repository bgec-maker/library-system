...
- [ ] 47 finish-p1 — 디자인 연구 P1 3건(카탈로그 줄바꿈·등록폼 잘림·위젯 가림)
- [ ] 48 finish-p2 — 디자인 연구 P2 4건(최근처리 내용화·트레이 접기·트리맵 대비·학생 응급)
- [ ] 49 finish-p3 — 디자인 연구 P3 3건(창 높이·헤더 과밀·하단 3층)
- [ ] 50 dock-redesign — 좌측 도크 그룹·호버 라벨·활성 표시
