...
- [x] 91 undo-bar-geometry — 데스크톱 언두바 기하 실결함 (시각 감사 1R)
- [x] 92 dash-head-badge-gap — 대시보드 패널 제목·배지 밀착 (시각 감사 1R)
...
- [x] 112 gate-url-hint — 세션게이트 URL 오형식 침묵 (시각 감사 11R)
...
- [x] 125 member-web-api — GAS: memberList/Register/Update/classCodes 웹 액션
...
- [ ] 130 window-bounds — 창 좌표 격리: 4방향 클램프·오염 저장 복원·리사이즈 앵커 (유실 실결함)
- [ ] 131 window-interactions — 도크 중복 창·스냅 저장 덮기·z 도크 잠식·더블클릭 최대화·포인터 캡처
